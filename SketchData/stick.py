...
train_dataset = MyDataset(root_dir='./image/train/',
                          names_file='./image/train/pointdatatrain.csv',
                          transform=None)
test_dataset = MyDataset(root_dir='./image/test/',
                          names_file='./image/test/pointdatatest.csv',
                          transform=None)
